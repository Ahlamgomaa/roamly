...
@Composable
fun SuccessDetailRow(label: String, value: String, isPrimary: Boolean = false, isBold: Boolean = false) {
    Row(
        ...
        Text(
            ...
            fontWeight = if (isBold || isPrimary) FontWeight.Bold else FontWeight.Normal,
